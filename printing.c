#include "main.h"
/**
 * print_any_string - This function picks a string as
 * an argument and prints it.
...
/**
 * termination - This function is called anytime we need to
 * terminate the getline function
 * Return: void
 */
 ...
 * buffer string and strips off the new line character
